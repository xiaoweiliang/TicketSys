...
class Cache {
     ...
     * @return object
     */
    public function connect($type='',$options=array(),$model=null) {
        if(empty($model))
            $type="File";
     ...
     * @return mixed
     */
    static function getInstance($type='',$options=array(),$model=null) {
		static $_instance	=	array();
		$guid	=	$type.to_guid_string($options);
		if(!isset($_instance[$guid])){
			$obj	=	new Cache();
			$_instance[$guid]	=	$obj->connect($type,$options,$model);
		}
