...
class Dispatcher {
    ...
    static public function dispatch() {
       ...
       //var_dump($_SERVER);
        ...
        // 获取控制器和操作名
        define('CONTROLLER_NAME',   defined('BIND_CONTROLLER')? BIND_CONTROLLER : self::getController($varController,$urlCase));                   //获取控制层
        define('ACTION_NAME',       defined('BIND_ACTION')? BIND_ACTION : self::getAction($varAction,$urlCase));                                                   //获取action
