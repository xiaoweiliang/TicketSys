...
return  array(
    ...
    'COOKIE_PREFIX'         =>  'TickerSys',      // Cookie前缀 避免冲突
    ...
    'SESSION_OPTIONS'       =>  array(),             //session过期时间，如果不设就是php.ini中设置的默认值), // session 配置数组 支持type name id path expire domain 等参数
    ...
    'HTML_CACHE_RULES'=> array(
         'City:GetCityInfo'=>array('{:module}_{:action}_{id}',0)
    ),
    ...
    'LAYOUT_ON'             =>  false, // 是否启用布局                   用在让每一个模板都有一个头模板或者foot模板或者两者都有的情况下    具体见开发文档                       和yii框架的差不多      yii的 render会自动加载模板   renderpartical不会加载模板
